			...
			Program "vp" {
				SubProgram "gles " {
					...
					void main()
					{
					    ...
					    SV_Target0.xyz = u_xlat16_1.xyz * vs_TEXCOORD3.xyz + u_xlat16_1.xyz;
					    SV_Target0.w = 1.0;
					    return;
					}
				...
				SubProgram "gles " {
					...
					void main()
					{
					    u_xlat10_0.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
					    u_xlat16_1.xyz = u_xlat10_0.xyz * _Color.xyz;
					    u_xlat16_1.xyz = u_xlat16_1.xyz * vs_TEXCOORD3.xyz + u_xlat16_1.xyz;
				...
				SubProgram "gles " {
					...
					void main()
					{
					    ...
					    u_xlat16_0.xyz = texture2D(unity_Lightmap, vs_TEXCOORD3.xy).xyz;
					    u_xlat16_2.xyz = u_xlat16_0.xyz * unity_Lightmap_HDR.xxx;
					    u_xlat0.xyz = u_xlat16_1.xyz * u_xlat16_2.xyz + (-unity_FogColor.xyz);
				...
				SubProgram "gles " {
					...
					void main()
					{
					    ...
					    u_xlat10_0.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
					    u_xlat16_2.xyz = u_xlat10_0.xyz * _Color.xyz;
					    u_xlat0.xyz = u_xlat16_2.xyz * u_xlat16_1.xyz + (-unity_FogColor.xyz);
					    u_xlat9 = vs_TEXCOORD2.w;
					    u_xlat9 = clamp(u_xlat9, 0.0, 1.0);
					    u_xlat0.xyz = vec3(u_xlat9) * u_xlat0.xyz + unity_FogColor.xyz;
					    SV_Target0.xyz = u_xlat0.xyz;
