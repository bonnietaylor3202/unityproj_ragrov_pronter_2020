Shader "Effect/AdditionEffectShader" {
	Properties {
	...
	SubShader {
		...
		0 {
			LOD 100
			Tags { "IGNOREPROJECTOR" = "true" "QUEUE" = "Transparent" "RenderType" = "Transparent" }
			Blend AssetRipper.SourceGenerated.Subclasses.SerializedShaderFloatValue.SerializedShaderFloatValue_5_6_0_b1 One, SrcAlpha One
			ColorMask RGB -1
			ZWrite Off
			Cull Off
			Fog {
