Shader "CustomShader/Diffuse" {
	...
	SubShader {
		...
		0 {
			...
			Blend AssetRipper.SourceGenerated.Subclasses.SerializedShaderFloatValue.SerializedShaderFloatValue_5_6_0_b1 OneMinusSrcAlpha, SrcAlpha OneMinusSrcAlpha
			Fog {
				Mode 0
			}
			GpuProgramID 57675
				...
				SubProgram "gles3 " {
					...
					void main()
					{
					    ...
					    for(int u_xlati_loop_1 = 0 ; u_xlati_loop_1<unity_VertexLightParams.x ; u_xlati_loop_1++)
					    {
					        ...
					        u_xlat16_8.xyz = vec3(u_xlat16_34) * _Color.xyz;
					        u_xlat16_8.xyz = u_xlat16_8.xyz * unity_LightColor[u_xlati_loop_1].xyz;
